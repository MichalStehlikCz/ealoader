...
class EaEntityGrpManagerImpl implements EaEntityGrpManager {
    ...
    @Nonnull
    private final Map<DtUid, Package> packageById = new ConcurrentHashMap<>(10);
    ...
    @Nonnull
    public Package getPackage(DtUid entityGrpId) {
    ...
    @Override
    public void syncPackage(String entityGrpNm) {
        syncPackage(entityGrpManager.getByNameNm(entityGrpNm));
    }
